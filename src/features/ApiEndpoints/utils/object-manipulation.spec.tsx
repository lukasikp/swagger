...
describe("Object manipuation utils", () => {
  it("Should group paths by endpoint", () => {
    ...
    expect(Object.keys(testedResult.pet)).toHaveLength(5);
    expect(Object.keys(testedResult.store)).toHaveLength(3);
    expect(Object.keys(testedResult.user)).toHaveLength(6);
  });
});
